...
<div class="app-title">
    <div>
        <h1><i class="fas fa-plus pr-2"></i>Danh Sách Sản Phẩm</h1>
        <p>Bạn có thể quản lý sản phẩm</p>
    </div>
</div>
<div class="row">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:15%;"><img src="/cuulongseed/public/Hinh-Anh/San-Pham/{{$sp->HinhAnh}}" alt="{{$sp->TenSanPham}}" class="img-thumbnail"></td>
