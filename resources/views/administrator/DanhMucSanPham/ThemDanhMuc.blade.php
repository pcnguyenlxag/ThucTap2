...
<form method="post" enctype="multipart/form-data">
     ...
     <!-- <div class="form-group">
         <div class="input-group">
             <div class="input-group-prepend">
                 <label class="input-group-text" for="HinhAnh">Chọn Ảnh</label>
             </div>
             <div class="custom-file">
                 <input type="file" class="custom-file-input" id="HinhAnh" name="HinhAnh" hidden accept="image/*">
                 <input class="custom-file-label" type="text" placeholder="Tải Ảnh Lên" name="Hinhanh123" value="@if(isset($danhmucid)){{$danhmucid->HinhAnh}}@endif">
             </div>
         </div>
     </div> -->
     ...
     <div class="form-group">
        ...
        <textarea class="form-control" id="MoTa" name="MoTa" rows="4" >@if(isset($danhmucid)){{$danhmucid->MoTa}}@endif</textarea>
        <script type="text/javascript">
